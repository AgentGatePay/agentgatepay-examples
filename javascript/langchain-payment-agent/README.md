...
[![AgentGatePay SDK](https://img.shields.io/badge/agentgatepay--sdk-1.1.6+-blue.svg)](https://www.npmjs.com/package/agentgatepay-sdk)
...
- **REST API version** - Uses published AgentGatePay SDK (v1.1.6+) from npm
...
**Uses:**
- AgentGatePay SDK (agentgatepay-sdk@^1.1.6) from npm
